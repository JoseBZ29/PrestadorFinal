...
class ServicioEnCursoCotizacionPage extends StatefulWidget {
  ServicioEnCursoCotizacionPage({Key key}) : super(key: key);

  @override
  _ServicioEnCursoCotizacionPageState createState() =>
      _ServicioEnCursoCotizacionPageState();
}

class _ServicioEnCursoCotizacionPageState
    extends State<ServicioEnCursoCotizacionPage> {
    ...
    if (qr == futureString) {
      ...
      AwesomeDialog(
          ...
          btnOkOnPress: () async {
            debugPrint('OnClcik');
            SharedPreferences pref = await SharedPreferences.getInstance();
            pref.setString('servicioEnCursoCotizacion', 'false');
