...
class ServicioEncursoPresupuestoPage extends StatefulWidget {
  ...
  @override
  _ServicioEnCursoPresupuestoPageState createState() =>
      _ServicioEnCursoPresupuestoPageState();
}

class _ServicioEnCursoPresupuestoPageState
    extends State<ServicioEncursoPresupuestoPage> {
    ...
    if (qr == futureString) {
      ...
      AwesomeDialog(
          ...
          btnOkOnPress: () async {
            debugPrint('OnClcik');
            SharedPreferences pref = await SharedPreferences.getInstance();
            pref.setString('servicioEnCursoPresupuesto', 'false');
  ...
  _scanQR() async {
    ...
    if (qr == futureString) {
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              title: Text('Se ha validado el codigo QR'),
              actions: <Widget>[
                FlatButton(
                    onPressed: () {
                      Navigator.of(context).pop();
